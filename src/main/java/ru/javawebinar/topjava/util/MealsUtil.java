...
import ru.javawebinar.topjava.storage.MapIdMealStorage;
...
public class MealsUtil {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println(filteredByRecursionWithCycleAndRunnable(meals, startTime, endTime, CALORIES_PER_DAY));
    ...
    */
    ...
    public static Storage<Integer, Meal> getStorage() {
        MapIdMealStorage storage = new MapIdMealStorage();
